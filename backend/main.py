...
def ask(req: AskRequest):
    ...
    sources = [
        Source(
            subject=t["metadata"].get("subject", ""),
            sender=t["metadata"].get("first_sender", ""),
            date=t["metadata"].get("first_date", ""),
            participants=t["metadata"].get("participants", ""),
            message_count=t["metadata"].get("message_count", 1),
